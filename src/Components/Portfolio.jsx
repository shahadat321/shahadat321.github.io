                    ...
                    <div className="wrapper--push work-push-up">
                        ...
                        <div className="work-half">
                            ...
                            <Scene classToggle="fade-up" reverse={true} offset={-300}>
                                <div className="work-half--item fade-effect">
                                    <div className="hover-effect">
                                        <a href="https://signsimpli.com/" target="_blank" rel="noreferrer nofollow">
                                            <img src="./images/port-12.jpg" loading="lazy" alt="" />
                                            <div className="work-overlay">
                                            <div className="work-overlay--content">
                                                    <h5 className="work-item--text item-title">SignSimpli.com</h5>
                                                    <h5 className="work-item--text item-description">Created component-based layout, ASP.NET MVC framework, Bootstrap, CSS pre-processor SCSS/SASS and Azure.</h5>
                                                    <button className="work-item--text item-btn" type="button" title="PDFSimpli.com">View Project</button>
                                                </div>
                                            </div>
                            ...
                            <Scene classToggle="fade-up" reverse={true} offset={-300}>
                                <div className="work-half--item fade-effect">
                                    <div className="hover-effect">
                                        <a href="https://uilab.in/" target="_blank" rel="noreferrer nofollow">
                                            <img src="./images/port-13.jpg" loading="lazy" alt="" />
                                            <div className="work-overlay">
                                                <div className="work-overlay--content">
                                                    <h4 className="work-item--text item-title">UILab.in</h4>
                                                    <h5 className="work-item--text item-description">Created component-based layout, JavaScript library ReactJS, CSS pre-processor SCSS, CSS Animations and GitHub.</h5>
                                                    <button className="work-item--text item-btn" type="button" title="TheQuint.com">View Project</button>
                                                </div>
                                            </div>
                                        </a>
                                ...
                                <div className="work-half--item fade-effect">
                                    <div className="hover-effect">
                                        <a href="https://www.thequint.com/quintlab/buri-ladki-game/" target="_blank" rel="noreferrer nofollow">
                                            ...
                                            <div className="work-overlay">
                                                <div className="work-overlay--content">
                                                    <h4 className="work-item--text item-title">Buri Ladki - The Quint</h4>
                                ...
                                <div className="work-half--item fade-effect">
                                    <div className="hover-effect">
                                        <a href="https://braahmam.net/" target="_blank" rel="noreferrer nofollow">
                                            ...
                                            <div className="work-overlay">
                                                <div className="work-overlay--content">
                                                    <h4 className="work-item--text item-title">Braahmam Net Solutions Pvt Ltd</h4>
                            ...
                            <Scene classToggle="fade-up" reverse={true} offset={-300}>
                                <div className="work-half--item fade-effect">
                                    <div className="hover-effect">
                                        <a href="https://www.thequint.com/quintlab/ampstories/2-point-0-movie-interesting-facts/" target="_blank" rel="noreferrer nofollow">
                                            <img src="./images/port-amp-1.jpg" loading="lazy" alt="" />
                                            <div className="work-overlay">
                                                <div className="work-overlay--content">
                                                    <h4 className="work-item--text item-title">About 2.0 Movie - AMP Story</h4>
                                                    <h5 className="work-item--text item-description">Develop component-based layout,  Card based layout, Accelerated Mobile Pages (AMP).</h5>
                                                    <button className="work-item--text item-btn" type="button" title="SandeshtoaSoldier">View Project</button>
                                                </div>
                                            </div>
                                        </a>
                            ...
                            <Scene classToggle="fade-up" reverse={true} offset={-300}>
                                <div className="work-half--item fade-effect">
                                    <div className="hover-effect">
                                        <a href="https://www.thequint.com/quintlab/what-sanju-missed-about-sanjay-dutts-life/" target="_blank" rel="noreferrer nofollow">
                                            <img src="./images/port-amp-2.jpg" loading="lazy" alt="" />
                                            <div className="work-overlay">
                                                <div className="work-overlay--content">
                                                    <h4 className="work-item--text item-title">Sanjay Dutt Life - AMP Story</h4>
                                                    <h5 className="work-item--text item-description">Develop component-based layout,  Card based layout, Accelerated Mobile Pages (AMP).</h5>
                                                    <button className="work-item--text item-btn" type="button" title="SandeshtoaSoldier">View Project</button>
                                                </div>
                                            </div>
